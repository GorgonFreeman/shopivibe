...
function snippetNameFromSelection(doc, sel) {
    ...
    for (const r of ranges) {
        const inside = sel.start.character >= r.startChar && sel.end.character <= r.endChar;
        if (!inside) {
            continue;
        }
 ...
 */
function registerDoubleClickOpen(context) {
    let debounce;
